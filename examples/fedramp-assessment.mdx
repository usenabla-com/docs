...
curl -X POST https://api.usenabla.com/v1/fedramp \
  ...
  -d '{
    "name": "Production Infrastructure FedRAMP Assessment",
    "format": "oscal",
    "source_type": "terraform_state",
    "source_path": "s3://my-terraform-state/prod/terraform.tfstate",
